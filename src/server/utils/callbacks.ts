...
export type LegacyCallbackHandler<T extends any[] = any[], R = void> = (source: number, cb: (...res: R[]) => void, ...args: T) => void;
 ...
 */
export function RegisterCallback<T extends any[] = any[], R = void>(event: string, handler: CallbackHandler<T, R>): void {
 ...
 */
export function RegisterLegacyCallback<T extends any[] = any[], R = void>(event: string, handler: LegacyCallbackHandler<T, R>): void {
